      ...
      {data.length !== 0 ?
        <div className="container">
          <div className="row mt-4">
            <div className="col-12 col-md-3 col-sm-12">
              ...
              <LazyLoadImage className="img-fluid w-100" src={POSTER_PATH + WIDTH_ORIGINAL + data.profile_path} effect="opacity" alt={data.name} onError={(e) => { e.target.onerror = null; e.target.src = frame4 }} />
              <div className="mt-4">
        ...
        <div className='vh-100 d-flex justify-content-center align-items-center text-center'>
          <div>
            ...
            <div className='mt-3 mb-5'>No person found ...</div>
